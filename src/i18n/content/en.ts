/**
 * English copy — the canonical shape. Every other locale is typechecked
 * against `typeof en`, so a missing or misspelled key fails `astro check`
...
export const en = {
  ...
  hero: {
    ...
    lede2:
      'Private by design. Open source. Self-hostable. No ads, no data resale, no awkward “engagement” notifications.',
    primaryCta: 'Start using Monica',
    githubCta: (count: string) => `View on GitHub · ${count} stars`,
  ...
  showcase: {
    ...
    aside:
      'People are complicated. Their contact records should be allowed to be slightly complicated too.',
  ...
  v3: {
    ...
    body2:
      'It will be more flexible, more extensible, and much better on phones—while preserving the privacy and ownership principles that made Monica useful in the first place.',
  ...
  founder: {
    ...
    body2:
      'Not because they were unimportant. Because life is busy, memory is unreliable, and apparently the human brain did not ship with search.',
    body3:
      'Monica started as a personal project in 2017. It has since become one of the most widely followed open-source personal CRM projects, supported and improved by contributors around the world.',
