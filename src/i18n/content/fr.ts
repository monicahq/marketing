...
export const fr: Dictionary = {
  ...
  nav: {
    ...
    stars: (count: string) => `${count} étoiles`,
  },
  ...
  hero: {
    ...
    lede2:
      'Privée par conception. Open source. Auto-hébergeable. Aucune publicité, aucune revente de données, aucune notification gênante pour vous « réengager ».',
    primaryCta: 'Commencer avec Monica',
    githubCta: (count: string) => `Voir sur GitHub · ${count} étoiles`,
  ...
  showcase: {
    ...
    aside:
      'Les gens sont compliqués. Leurs fiches ont bien le droit d’être un peu compliquées aussi.',
    card: {
      name: 'Élise Aubert',
  ...
  v3: {
    ...
    body2:
      'Elle sera plus souple, plus extensible et bien meilleure sur téléphone — tout en préservant les principes de confidentialité et de propriété qui ont rendu Monica utile dès le départ.',
  ...
  founder: {
    ...
    body2:
      'Pas parce qu’ils étaient sans importance. Parce que la vie est chargée, que la mémoire est peu fiable et que le cerveau humain n’est apparemment pas livré avec une fonction de recherche.',
    body3:
      'Monica a commencé comme un projet personnel en 2017. C’est devenu depuis l’un des projets de CRM personnel open source les plus suivis, soutenu et amélioré par des contributeurs du monde entier.',
