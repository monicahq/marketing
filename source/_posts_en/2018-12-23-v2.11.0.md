...
author: 'Regis Freyd'
description: 'Introducing emotions, photo upload, enhanced security and better phone call management.'
...
You can now upload photos on a contact’s profile page. The number of photos you can store depends on your account’s storage limit, which is 512 Mb on [https://monicahq.com](https://monicahq.com) (and is configurable per instance). The ability to upload photos unlocks a lot of possibilities in the future.

![The photos tab on a contact, empty, offering to upload the first picture.](/assets/images/blog/2018-12-04-photo-upload.webp)
...
![The recovery codes dialog, listing eight single-use codes with one already crossed out.](/assets/images/blog/2018-12-02-recovery-codes.webp)
...
![The call form, asking how you felt during the call, with two emotions already chosen.](/assets/images/blog/2018-12-13-emotions.webp)
...
![A contact's profile showing the current weather where that person lives.](/assets/images/blog/2018_12_22_weather.webp)
...
![The dashboard's tasks tab, with three tasks that belong to no contact.](/assets/images/blog/2018-11-17-custom-tasks.webp)
