...
[https://version.monicahq.com](https://version.monicahq.com). The ping contains three information:
...
The code of [https://version.monicahq.com](https://version.monicahq.com) is open-source, stored
...
![Monica's footer, showing the version number and a badge saying a new version is available.](/assets/images/blog/2017-07-25-v0.5.0-footer.webp)
...
to [https://version.monicahq.com](https://version.monicahq.com), simply add the following to your `.env` file:
...
![Search results appearing as you type, listing the contacts whose names match.](/assets/images/blog/2017-07-25-v0.5.0-search.webp)
